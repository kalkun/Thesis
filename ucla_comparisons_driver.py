...
"""
This is script is used to insert scores from UCLA
into the db based on the csv file they've sent us
"""
...
def main(csv_path, add_to_db):
    ...
    for im in imgs:
        ...
        img_hash_name[im.imageHASH] = im.name
    ...
    with open(csv_path, 'r') as f:
        ...
        for indx, row in enumerate(reader):
            ...
            # if name not a key in dict of img names, assume its only a hash:
            img1_name = img1_name if img1_name in img_name_hash else img_hash_name[img1_name]
            img2_name = img2_name if img2_name in img_name_hash else img_hash_name[img2_name]
